...
import SettingsListItem from "@/components/Modals/SettingsModal/SettingsListItem/SettingsListItem";
...
const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const handleClickDropdown = (
    ...
    setSettings({
      ...settings,
      fontSizeDropDownIsOpen: !settings.fontSizeDropDownIsOpen,
    });
  };
  return (
              ...
              <div className="mt-6 flex justify-between first:mt-0">
                ...
                <div className="w-[170px]">
                  <div className="relative">
                    ...
                    {settings.fontSizeDropDownIsOpen && (
                      <ul
